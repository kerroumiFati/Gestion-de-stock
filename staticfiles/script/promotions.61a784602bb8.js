...
async function loadProduits() {
    try {
        ...
        // Initialiser Select2 sur le select produit
        initializeSelect2();
    } catch (error) {
...
function initializeSelect2() {
    ...
    if (typeof $ === 'undefined' || typeof $.fn.select2 === 'undefined') {
        console.warn('[PROMOTIONS] jQuery ou Select2 non disponible');
        return;
    }
    ...
    // Gérer les événements de changement avec Select2
    $produitSelect.on('change', function() {
        ...
        // Désélectionner la catégorie si un produit est sélectionné
        if (value) {
            $categorieSelect.val('').trigger('change');
        }
    });
    ...
    console.log('[PROMOTIONS] Select2 initialisé');
}
