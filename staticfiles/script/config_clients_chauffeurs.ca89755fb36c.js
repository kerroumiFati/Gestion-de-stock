...
async function renderClientLists() {
    ...
    document.getElementById('availableCount').textContent = availableClients.length;

    // Afficher les clients assignés
    renderClientList('assignedClientsList', assignedClients, 'assigned');
    document.getElementById('assignedCount').textContent = assignedClients.length;
}
...
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', window.initConfigClientsChauffeursPage);
} else {
