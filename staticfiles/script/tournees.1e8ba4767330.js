...
function loadTourneeData(id) {
    ...
    ensureClientsLoaded
        ...
        .then(tournee => {
            ...
            console.log('[TOURNEES] Champs: date=' + tournee.date + ', warehouse=' + tournee.warehouse + ', livreur=' + tournee.livreur);
            ...
            if (warehouseSelect && tournee.warehouse) {
                ...
                if (selectedOption && selectedOption.value) {
                    updateCustomSelectTrigger('warehouseTrigger', selectedOption.text);
                }
                console.log('[TOURNEES] Warehouse défini:', warehouseSelect.value);
            }
            ...
            if (heureDepart) {
                heureDepart.value = formatTimeForInput(tournee.heure_depart_prevue);
                console.log('[TOURNEES] Heure départ définie:', heureDepart.value);
            }
            if (heureRetour) {
                heureRetour.value = formatTimeForInput(tournee.heure_retour_prevue);
            ...
            if (commentaireInput) {
                commentaireInput.value = tournee.commentaire || '';
            }
