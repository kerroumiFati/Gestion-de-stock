(function(){
  ...
  function ajaxJSON(opts){
    ...
    // S'assurer que les credentials sont envoyés
  ...
  function loadList(){
    ...
    const params = include_inactive ? '?include_inactive=1' : '';
    return ajaxJSON({
      url: apiBase + '/entrepots/' + params,
      method: 'GET',
      contentType: false  // Pour GET, pas besoin de contentType
    }).then(function(items){
