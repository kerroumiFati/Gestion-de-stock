...
(function($){
  ...
  function renderAchats(list){
    ...
    if(!$tbody.length){
      dbg('renderAchats: tbody not found!');
      return;
    }
      ...
      if($.fn.DataTable && list && list.length > 0){
        achatsDataTable = $table.DataTable({
          ...
          language: {
            ...
            "sEmptyTable":     "Aucun achat disponible",
            "oPaginate": {
              "sFirst":      "Premier",
